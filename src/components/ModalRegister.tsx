...
export default function ModalRegister() {
  ...
  const registerBtnOnClick = () => {
    ...
    let hadPlanSelect = true;
    if (plan === "") {
      hadPlanSelect = false;
      setPlanError(true);
    }

    let hadGenderSelect = true;
    if (gender === "") {
      hadGenderSelect = false;
      setGenderError(true);
    }

    if (fnameOk && lnameOk && hadPlanSelect && hadGenderSelect) {
      alert(
      ...
      <div className="modal-dialog">
        <div className="modal-content">
          ...
          <div className="modal-body">
            ...
            <div className={"text-success" + (buyBottle && buyShoes && buyCap ? "" : " d-none")}>(20% Discounted)</div>
